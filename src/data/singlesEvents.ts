...
export const singlesEvents: SinglesEvent[] = [
  ...
  },
  {
    ...
    source: "https://www.eventbrite.com/d/ok--oklahoma-city/single-awareness-dinner/",
    tags: ["weekly", "dinner", "rotating venue", "casual"],
  },
  {
    id: "mx-03",
    name: "Single Awareness Dinner: Ladies Edition",
    organizer: "Ermantourage Dinner with Strangers",
    venue: "Rotating venues",
    neighborhood: "Citywide",
    frequency: "Bi-weekly",
    price: "Cost of your meal",
    category: "Mixer",
    description: "Women-only version of the Single Awareness Dinner. Rotating restaurant format organized by Ermantourage. Build friendships and connections in a relaxed dining setting.",
    source: "https://www.eventbrite.com/o/ermantourage-okc-82aborede74803",
  ...
  },
  {
    ...
    source: "https://www.eventbrite.com/d/ok--oklahoma-city/foodies-new-friends/",
    tags: ["30s", "foodie", "weekly", "curated"],
  },
  {
    id: "mx-05",
    name: "Dinner with Entrepreneurs: OKC",
    organizer: "Ermantourage OKC",
    venue: "Rotating upscale restaurants",
    neighborhood: "Citywide",
    frequency: "Bi-weekly",
    price: "Cost of your meal",
    category: "Mixer",
    description: "Networking dinner for single professionals and entrepreneurs. Curated guest lists, upscale rotating venues. Meet ambitious people in an intimate dinner setting.",
    source: "https://www.eventbrite.com/d/ok--oklahoma-city/dinner-with-entrepreneurs/",
    tags: ["professionals", "networking", "upscale", "curated"],
  },
  {
    id: "dn-01",
  ...
  {
    id: "mx-06",
    name: "Foodies + New Friends: Charity Edition",
    organizer: "ADDVentures",
    venue: "Rotating restaurants",
    neighborhood: "Citywide",
    frequency: "Monthly",
    price: "Cost of your meal + donation",
    category: "Mixer",
    description: "Monthly charity-themed dinner for singles. Same ADDVentures format with a portion of proceeds going to a local Oklahoma City nonprofit. Great food, new people, good cause.",
    source: "https://www.eventbrite.com/d/ok--oklahoma-city/foodies-new-friends/",
    tags: ["charity", "dinner", "monthly", "give back"],
  },
];
