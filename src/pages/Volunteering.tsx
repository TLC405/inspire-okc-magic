...
const features = [
  { num: "01", title: "Local Nonprofits", desc: "Connect with established nonprofits and community organizations across Oklahoma City that need your time and energy.", icon: Home },
...
const neighborhoods = ["Capitol Hill", "Del City", "Midwest City", "Spencer", "NE Oklahoma City", "SW Oklahoma City", "Moore", "Norman"];
          ...
          <div className="container max-w-5xl">
            <ScrollReveal>
              <div className="flex items-center gap-3 mb-6">
                <span className="font-mono text-primary-foreground/20 text-xs">REF: OKLAHOMA-CITY-VOLUNTEER-003</span>
          ...
          <div className="container max-w-3xl">
            <ScrollReveal>
              <div className="quote-block">
                ...
                <p className="label-caps text-muted-foreground/40 mt-8">— Volunteering Oklahoma City</p>
              </div>
            </ScrollReveal>
          </div>
        </section>
            ...
            <ScrollReveal>
              <div className="border-2 border-accent p-8 md:p-12 text-center">
                ...
                <p className="text-sm text-muted-foreground max-w-md mx-auto">
                  Volunteering Oklahoma City is in development. Your central hub for every way to give back.
                </p>
              </div>
            </ScrollReveal>
          </div>
