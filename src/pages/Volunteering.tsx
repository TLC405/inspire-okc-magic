    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
        <div className="container pt-6 md:pt-12">
          ...
          <p className="dateline text-muted-foreground mb-2">Oklahoma City · {volunteerOrgs.length} Organizations · Live</p>
          <div className="rule-thin mb-4" />

          <div className="relative mb-4">
            <Search size={15} className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground/40" />
            <input type="text" value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search organizations, causes..." className="skeuo-search pl-11" />
          </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap items-center gap-1.5 mt-3">
                          ...
                          {org.tags.slice(0, 3).map((t) => (<span key={t} className="skeuo-badge">{t}</span>))}
                        </div>
                      </div>
                    </div>
                  </article>
