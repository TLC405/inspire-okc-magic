...
const faqs = [
  ...
  { question: "Who is this for?", answer: "Anyone in the Oklahoma City metro area looking to connect with people and opportunities. From Midtown to Bricktown, Paseo to NW Oklahoma City. No age requirement, no membership, no gatekeeping." },
  { question: "Can I use multiple directories?", answer: "Absolutely. They're all independent tools. Use one, use all five — whatever fits your life right now. Many people start with one and discover the others organically." },
            ...
            <ScrollReveal>
              <div className="quote-block">
                ...
                <p className="text-lg md:text-xl text-foreground/80 leading-relaxed">
                  INSPIRE Oklahoma City is a collection of five community directories designed to make belonging in Oklahoma City effortless. We serve the entire metro — from Deep Deuce to Automobile Alley, Film Row to Uptown 23rd. No memberships, no dues, no applications. Just tools that help you find your people.
                </p>
              </div>
            </ScrollReveal>
          </div>
            ...
            <ScrollReveal>
              <div className="border-2 border-border">
                <Accordion type="single" collapsible>
                  {faqs.map((faq, i) => (
                    <AccordionItem key={i} value={`item-${i}`} className="border-b-2 border-border last:border-b-0 px-6 md:px-8 data-[state=open]:border-l-4 data-[state=open]:border-l-accent data-[state=open]:bg-secondary/30">
                      ...
                      <AccordionContent className="text-muted-foreground text-sm leading-relaxed pb-6 pl-10">{faq.answer}</AccordionContent>
                    </AccordionItem>
                  ))}
                </Accordion>
              </div>
        ...
        <section className="py-24 md:py-32 bg-primary text-primary-foreground border-t-2 border-border">
          <div className="container max-w-3xl">
            <ScrollReveal>
              ...
              <h2 className="text-4xl md:text-6xl font-black tracking-[-0.03em] leading-[0.9] mb-6">Still have questions?</h2>
              ...
              <p className="text-xs text-primary-foreground/15 font-mono">405 · Oklahoma City · 73507</p>
            </ScrollReveal>
          </div>
        </section>
      </main>
