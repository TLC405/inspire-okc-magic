...
import { ArrowRight, Dumbbell, MapPin, Timer, Mountain } from "lucide-react";
import { Link } from "react-router-dom";

const features = [
  { num: "01", title: "Group Runs & Rides", desc: "Weekly group runs, cycling meetups, and outdoor movement sessions across Oklahoma City trails.", icon: Timer },
  ...
  { num: "03", title: "Outdoor Adventures", desc: "Trail hikes, lake workouts, and outdoor bootcamps — fitness beyond four walls.", icon: Mountain },
];

const spots = ["Lake Hefner", "Scissortail Park", "River Trails", "Stars & Stripes Park", "Bluff Creek", "Martin Park", "Overholser", "Will Rogers Park"];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
          ...
          <div className="container max-w-5xl">
            <ScrollReveal>
              <div className="flex items-center gap-3 mb-4">
                ...
                <SignalChip label="Fitness" variant="default" />
              </div>
              <h1 className="display-hero mb-4">Fitness</h1>
              ...
              <p className="text-base md:text-lg text-primary-foreground/40 max-w-xl leading-relaxed">
                All things fitness — gyms, group runs, outdoor classes, and movement culture in Oklahoma City.
              </p>
            </ScrollReveal>
          </div>
        </section>
        ...
        <section className="border-b border-border bg-card">
          <div className="container max-w-5xl">
            <MetricRail items={[
              { label: "Locations", value: String(spots.length), accent: true },
          ...
          <div className="container max-w-3xl">
            <ScrollReveal>
              <div className="quote-block">
                ...
                <p className="mono-data text-muted-foreground/40 mt-6">— Fitness Oklahoma City</p>
              </div>
            </ScrollReveal>
          </div>
        </section>
          ...
          <div className="container max-w-5xl">
            <ScrollReveal>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="label-caps text-muted-foreground">Fitness Hotspots</span>
              </div>
            ...
            <ScrollReveal>
              <div className="border border-accent p-8 md:p-12">
                ...
                <p className="text-sm text-muted-foreground max-w-md mx-auto">
                  Your guide to every gym, trail, and group workout in the metro.
                </p>
              </div>
            </ScrollReveal>
          </div>
